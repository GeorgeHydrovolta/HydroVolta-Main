...
(function () {
  ...
  var CHAPTERS = [
    ...
    { key: 'tankcip', label: 'CIP Tank', page: 120, file: '17-cip-tank.pdf' },
    { key: 'tankelectrolyte', label: 'Electrolyte Tank', page: 126, file: '18-electrolyte-tank.pdf' },
    { key: 'telemetry', label: 'Telemetry & Remote Connectivity', page: 132, file: '19-telemetry-and-remote-connectivity.pdf' },
    { key: 'shutdown', label: 'Shutdown, Storage & Disposal', page: 138, file: '20-shutdown-storage-and-disposal.pdf' },
    { key: 'appparams', label: 'Appendix A: Parameter Tables', page: 144, file: '21-parameter-tables.pdf' },
    { key: 'appdrawings', label: 'Appendix B: Drawings', page: 148, file: '22-drawings.pdf' },
    { key: 'appcert', label: 'Appendix C: Certificates & Datasheets', page: 152, file: '23-certificates-and-datasheets.pdf' },
    { key: 'appglossary', label: 'Appendix D: Glossary', page: 158, file: '24-glossary.pdf' }
  ];
